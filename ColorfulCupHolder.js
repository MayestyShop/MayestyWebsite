...
function img1clicked(){
    document.getElementById("product-img-1").src = "Colorful Cup Holder/ColorfulCupHolder1.webp"
}
...
function img3clicked(){
    document.getElementById("product-img-1").src = "Colorful Cup Holder/ColorfulCupHolder3.webp"
}

function img4clicked(){
    document.getElementById("product-img-1").src = "Colorful Cup Holder/ColorfulCupHolder4.webp"
}
